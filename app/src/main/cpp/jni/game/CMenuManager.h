...
*/
#ifndef GTA_VC_CMENUMANAGER_H
#define GTA_VC_CMENUMANAGER_H
...
public:
    ...
    uintptr_t m_pSkinListHead;
    uintptr_t* m_pSelectedSkin;
...
public:
    ...
    int DisplayHelperText(const char* text);
